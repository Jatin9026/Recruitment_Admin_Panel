...
const PendingScreening = () => {
  ...
  return (
    <div className="min-h-screen p-3 sm:p-6 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white flex flex-col max-w-7xl mx-auto">
      <h1 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 border-b border-gray-300 pb-3">
        Pending Screening
      </h1>

      {applicants.length === 0 ? (
        <p className="text-center text-gray-500 text-base sm:text-lg flex-grow flex items-center justify-center px-4">
          No applicants pending screening.
        </p>
      ) : (
        <>
          <div className="hidden md:block flex-grow overflow-auto rounded-lg shadow border border-gray-300 bg-white dark:bg-gray-800">
          ...
          <div className="md:hidden space-y-4">
            {applicants.map((applicant) => (
              <div
                key={applicant.id}
                className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-300 dark:border-gray-600 p-4"
              >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Applied At:</span>
