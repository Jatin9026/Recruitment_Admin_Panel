...
export default function GroupManager() {
  ...
  // Check if all applicants in a group have been processed (selected or rejected)
  const isGroupComplete = (groupApplicants) => {
    return groupApplicants.every(applicant => {
      // Check local rejection state first
      ...
      // Applicant is complete if either locally marked for rejection or has GD status
  ...
  const updateGroupStatus = async (groupKey, groupApplicants) => {
    ...
    const groupSelected = groupApplicants.filter(a => !rejectedApplicants.has(a.email));
